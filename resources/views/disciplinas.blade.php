...
<div class="max-w-6xl mx-auto">
    ...
    <div class="card bg-white rounded-xl shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-lg font-semibold text-gray-800">Hola, Usuario Demo</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="card bg-white rounded-xl shadow-sm p-6">
            ...
            <p class="text-gray-600 text-sm mb-4">Fútbol 7 para participantes masculinos. Requiere condición física básica.</p>
    ...
    <div class="flex justify-end space-x-4">
        ...
        <button type="button" id="confirmar-inscripcion" 
                class="btn btn-primary opacity-50 cursor-not-allowed" disabled>
                ...
                button.addEventListener('click', function() {
                    ...
                    document.querySelectorAll('.card').forEach(card => {
                        ...
                        if (cardNombre === nombre) {
                            ...
                            btnOriginal.classList.add('bg-gray-200', 'text-gray-700', 'hover:bg-gray-300');
                            btnOriginal.innerHTML = '<i class="fas fa-plus mr-2"></i>Seleccionar';
                            card.classList.remove('ring-2', 'ring-blue-500');
                        }
                    });
