            ...
            <div class="p-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="w-10 h-10 flex items-center justify-center">
                        <img src="{{ asset('img/ARBOL_UTS.png') }}" alt="Logo UTS" class="w-full h-full object-contain rounded-lg">
                    </div>
                    <div class="ml-3">
                            ...
                            <div
                                ...
                                <div class="py-1">
                                    ...
                                    <form method="POST" action="{{ route('logout')}}">
                                        @csrf
                                        <button type="submit" class="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-gray-100">
                                        <i class="fas fa-sign-out-alt mr-3"></i>
